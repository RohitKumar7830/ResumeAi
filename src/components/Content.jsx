    ...
    <div className= 'flex justify-end mt-8'>
        <div className=' relative z-0 rounded-md w-screen mt-9 h-[50vh]  md:ml-80 md:mr-40 md:mt-14 bg-black md:w-[50vw] md:h-[80vh]' 
            ...
            <motion.div
              ...
              className= ' absolute w-3/4 border-2 rounded-md border-slate-500 h-2/3 p-4 top-56 right-10 inset-y-0 md:top-0  md:mt-20 md:border-2 z-10 flex flex-col md:right-[700px] md:w-2/3 md:pt-10 md:px-10 md:h-2/3 bg-white'>
                <div className='gap-3'>
